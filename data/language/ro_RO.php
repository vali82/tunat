...
return array(
	...
	"Invalid Credentials. Authentification failed!" => 'E-mail sau parola incorecte! Autentificare esuata!',
	...
	// OTHER ZEND PHP PHRASES
	"A 404 error occurred" => "A apărut o eroare 404",
    ...
    "I//nvalid type given. String expected" => "Invalid type given. String expected",
    ...
    "A record matching the input was found" => "O înregistrare identica a fost găsita in baza da date",
   ...
   // "Invalid type given. String expected" => "Invalid type given. String expected",
    ...
    //"Invalid type given. String, integer or float expected" => "Invalid type given. String, integer or float expected",
    "The input does not match against pattern '%pattern%'" => "Câmpul nu se potrivește cu modelul '%pattern%'",
   ...
   // "Invalid type given. String expected" => "Invalid type given. String expected",
    ...
    //"Invalid type given. String expected" => "Invalid type given. String expected",
    "The input is less than %min% characters long" => "Câmpul are o lungime de mai puțin de %min% caractere",
    "The input is more than %max% characters long" => "Câmpul are o lungime de mai mult de %max% caractere",
